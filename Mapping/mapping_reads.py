...
"""Usage: Align reads to Genome and trancriptome. This script is modified from GLORI"""
"""Input: [fastq files]"""
...
parser.add_argument("-i", "--DUOdir", nargs="?", type=str, default=sys.stdin,help = "Directory where DUO-tool is located")
